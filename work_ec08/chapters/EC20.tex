...
use it and discard it. This model loses materials, energy and technical value at the end of each life.
...
materials, maintenance and previous use, helping operators choose the correct recovery route.
...
service life across the complete system boundary. The objective is not simply to close a loop, but to
reduce total environmental impact while providing the required service.
\end{ecarticle}
...
\begin{center}
\begin{tikzpicture}
\begin{axis}[xbar,width=\linewidth,height=50mm,xlabel={Relative impact index},xmin=0,xmax=110,
